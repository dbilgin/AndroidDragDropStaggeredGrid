...
import com.iatsu.dragdropstaggeredgrid.Helper.Companion.addToMainLayout
import com.iatsu.dragdropstaggeredgrid.Helper.Companion.belongsRightLayout
...
class DragDropStaggeredGrid(context: Context, attrs: AttributeSet? = null) : RelativeLayout(context, attrs) {
    ...
    fun setViews(views: MutableList<View>, margin: Int) {
        for (i in 0 until views.size) {
            ...
            currentView.setOnLongClickListener(Helper.Companion.LongPressListener(currentView))
        }
    }
